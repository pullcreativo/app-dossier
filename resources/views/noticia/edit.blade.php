...
<div class="container">
	<div class="panel panel-info">
		...
		<div class="panel-body">
				...
				{{-- Fin de modal --}}
				<div class="row">
					<form action="{{route('noticias.update',$noticia->post->idpost)}}" method="POST" enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('PUT')}}
					<div class="col-sm-12 col-md-6">
							...
							<div class="input-group">
								<select name="tema" class="form-control">
									@foreach($temas as $tema)
										@if($noticia->post->idtema == $tema->idtema)
						...
						<div class="form-group {{ $errors->has('titulo') ? ' has-error' : '' }}">
							...
							<input type="text" name="titulo" class="form-control" placeholder="Ingrese título de la noticia" value="{{$noticia->post->titulo}}">
						...
						<div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
							...
							<textarea name="descripcion" rows="4" class="form-control" placeholder="Breve descripcion del noticia">{{$noticia->post->descripcion}}</textarea>
					...
					<div class="col-sm-12 col-md-6">
						<div class="form-group {{ $errors->has('contenido') ? ' has-error' : '' }}">
							<label for="contenido" class="control-label">Contenido de la noticia</label>
							<textarea name="contenido"  rows="3" 
							 class="form-control ckeditor">{{$noticia->contenido}}</textarea>

			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="form-group {{ $errors->has('titulo') ? ' has-error' : '' }}">
						...
						<input type="text" name="titulo" class="form-control" placeholder="Ingrese título de la noticia" value="{{old('titulo')}}">
					...
					<div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
						...
						<textarea name="descripcion" rows="4" class="form-control" placeholder="Breve descripcion del noticia">{{old('descripcion')}}</textarea>
					...
					<div class="form-group {{ $errors->has('fuente') ? ' has-error' : '' }}">
						...
						<input type="text" name="fuente" class="form-control" placeholder="Ingrese fuente" value="{{old('fuente')}}">
				...
				<div class="col-sm-12 col-md-6">
					<div class="form-group {{ $errors->has('contenido') ? ' has-error' : '' }}">
						...
						<textarea name="contenido"  rows="3" 
						 class="form-control ckeditor">{{old('contenido')}}</textarea>

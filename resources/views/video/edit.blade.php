...
<div class="container">
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="panel-titile">Editar video</div>
		</div>
		<div class="panel-body">
				...
				{{-- Fin de modal --}}
			<div class="row">
				<form action="{{route('videos.update',$video->post->idpost)}}" method="POST" enctype="multipart/form-data">
					{{csrf_field()}}
					{{ method_field('PUT')}}
					<div class="col-sm-12 col-md-6">
							...
							<div class="input-group">
								<select name="tema" class="form-control">
									@foreach($temas as $tema)
										@if($video->post->idtema ==$tema->idtema)
						...
						<div class="form-group {{ $errors->has('titulo') ? ' has-error' : '' }}">
							...
							<input type="text" name="titulo" class="form-control" placeholder="Ingrese título" value="{{$video->post->titulo}}">
						...
						<div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
							...
							<textarea name="descripcion" class="form-control" placeholder="Ingrese descripción" rows="4">{{$video->post->descripcion}}</textarea>
					...
					<div class="col-sm-12 col-md-6">
							...
							<div class="form-group {{ $errors->has('urlvideo') ? ' has-error' : '' }}">
								<label for="urlvideo" class="control-label">URL Video</label>
								 <div class="input-group">
								  ...
								  <input type="text" class="form-control" name="urlvideo" placeholder="Ejemplo: FVVj9bYH8SM" id="basic-url" aria-describedby="basic-addon3" value="{{$video->urlvideo}}">
								</div>
						...
						<div class="form-group">
							...
							<div class="radio">
								@if($video->priority == 1)
								<label style="margin-right: 20px;"><input checked type="radio" value="1" name="priority">Principal</label>
								<label><input type="radio" value="0" name="priority">General</label>
								@else

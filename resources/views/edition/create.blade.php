...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="panel-title">Nueva edición</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					<div class="form-group {{ $errors->has('nro_edition') ? ' has-error' : '' }}">
						...
						<input type="text" class="form-control" name="nro_edition" placeholder="Ingrese número de edición" value="{{old('nro_edition')}}">
					...
					<div class="form-group {{ $errors->has('name_pub') ? ' has-error' : '' }}">
						...
						<input type="text" class="form-control" name="name_pub" placeholder="Casas de Playa" value="{{old('name_pub')}}">
					...
					<div class="form-group">
						...
						<input type="date" class="form-control" name="fechapub" value="{{date('Y-m-d')}}">
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="form-group {{ $errors->has('editorial') ? ' has-error' : '' }}">
						<label for="editorial" class="control-label">Editorial</label>
						<textarea name="editorial" rows="4" class="form-control" placeholder="Detalle aquí sobre el editorial">{{old('editorial')}}</textarea>
					...
					<div class="form-group {{ $errors->has('autor') ? ' has-error' : '' }}">
						...
						<input type="text" class="form-control" name="autor" placeholder="Ingrese Autor" value="{{old('autor')}}">
						@if ($errors->has('autor'))
						    <span class="help-block">
					...
					<div class="form-group {{ $errors->has('portada') ? ' has-error' : '' }}">
						<label for="portada" id="img-name" class="btn btn-success">Subir Portada  <i class="fa fa-upload" aria-hidden="true"></i></label>
